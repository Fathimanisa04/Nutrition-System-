                ...
                <div className="flex-item-card-BMI">
                    <form className="center">
                      <div className="form-group">
                        <h5>BMI(Body Mass Index) levels:</h5>
                    <ul>
                    <li>Underweight: BMI less than 18.5</li>
                    <li>Normal weight: BMI of 18.5 to 24.9</li>
                    <li>Overweight: BMI of 25 to 29.9</li>
                    <li>Class I obesity: BMI of 30 to 34.9</li>
                    <li>Class II obesity: BMI of 35 to 39.9</li>
                    <li>Class III obesity (severe obesity): BMI of 40 or over</li>
                    </ul> 
